...
public class ParcelSizeConfiguration : IEntityTypeConfiguration<ParcelSize>
{
    public void Configure(EntityTypeBuilder<ParcelSize> builder)
    {
        ...
        builder.Property(parcelSize => parcelSize.Weight).HasColumnType("decimal(18,3)").IsRequired();
        builder.Property(parcelSize => parcelSize.NumberOfPoint).HasColumnType("int").IsRequired();
